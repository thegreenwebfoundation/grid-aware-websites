import { getGridIntensity as electricityMapsGridIntensity } from "./data/electricityMaps.js";
...
/**
 * The accepted data providers for fetching grid intensity data.
 * @type {string[]}
 */
const acceptedProvider = ["electricityMaps"];
